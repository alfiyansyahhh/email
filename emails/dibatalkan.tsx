        ...
        <Body className='bg-[#FAFAFA] my-auto mx-auto font-sans px-2'>
          <Container className='border relative border-solid border-[#eaeaea] rounded-xl my-[40px] mx-auto p-[20px] w-[660px]'>
            ...
            <Heading className=' text-[24px] text-[#432114] font-normal text-center p-0 my-[30px] mx-0'>
              <strong>Pesanan Telah Dibatalkan</strong>
            </Heading>
            <Section className='leading-[2px] text-center mt-10'>
              ...
              <Text className='text-black font-semibold text-[14px] text-center px-5 '>
                Kami telah menerima permintaan pembatalan pesanan. Pesanan ini
                telah dibatalkan sesuai dengan permintaan.
              </Text>
            </Section>
            ...
            <Text className='text-center mt-10'>
              Pengembalian dana akan dilakukan maksimal 3 hari kerja. Jika ada
              hal lain yang bisa kami bantu, jangan ragu untuk menghubungi tim
              kami.
            </Text>
            ...
            <Text className='text-center'>
              Terima kasih telah mengunjungi Stance Roasters. Kami harap dapat
              melayani kamu di lain waktu!
            </Text>
